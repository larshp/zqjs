...
Nine hundred sixty-two pinned test262 cases are selected for the transpiled ABAP engine across
...
skip separately. The current set reports nine hundred fifty-nine passes, one explicit `onlyStrict`
